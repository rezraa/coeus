...
"""Graph-backed knowledge loader for Coeus.

Wraps the JSON-based KnowledgeLoader (data stays in JSON for speed) and adds
write_memory() for persisting architecture decisions to the Kuzu graph.
"""
...
class GraphKnowledgeLoader(KnowledgeLoader):
    ...
    knowledge JSON files are the source of truth for architecture patterns,
    scalability patterns, API/data patterns, and decision rules).
    ...
    def write_memory(
        ...
        Args:
            memory_type: Category of memory, e.g. "architecture_decision".
